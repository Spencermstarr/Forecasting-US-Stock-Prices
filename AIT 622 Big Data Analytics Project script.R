...
data_2017c <- na.omit(data2017)  # same same for the 2017 financial dataset

# remove all rows with missing values from the 2018 financial dataset
mean(is.na(data2018))
data_2018c <- na.omit(data2018)
...
x2014c <- data_2014c$X
class2014c <- data_2014c$Class
sector2014c <- data_2014c$Sector
# 2015
x2015 <- data2015$X
class2015 <- data2015$Class
sector2015 <- data2015$Sector
x2015c <- data_2015c$X
class2015c <- data_2015c$Class
sector2015c <- data_2015c$Sector
# 2016
x2016 <- data2016$X
class2016 <- data2016$Class
sector2016 <- data2016$Sector
x2016c <- data_2016c$X
class2016c <- data_2016c$Class
sector2016c <- data_2016c$Sector
# 2017
x2017 <- data2017$X
class2017 <- data2017$Class
sector2017 <- data2017$Sector
x2017c <- data_2017c$X
class2017c <- data_2017c$Class
sector2017c <- data_2017c$Sector
# 2018
x2018 <- data2018$X
class2018 <- data2018$Class
sector2018 <- data2018$Sector
x2018c <- data_2018c$X
class2018c <- data_2018c$Class
sector2018c <- data_2018c$Sector
...
data_2014c <- subset(data_2014c, select = -c(X, Class, Sector))
data_2015c <- subset(data_2015c, select = -c(X, Class, Sector))
data_2016c <- subset(data_2016c, select = -c(X, Class, Sector))
data_2017c <- subset(data_2017c, select = -c(X, Class, Sector))
data_2018c <- subset(data_2018c, select = -c(X, Class, Sector))
...
pr_var2017 <- data2017$X2018.PRICE.VAR....
pr_var2018 <- data2018$X2019.PRICE.VAR....
...
pr_var2017c <- data_2017c$X2018.PRICE.VAR....
pr_var2018c <- data_2018c$X2019.PRICE.VAR....
data_2014c <- subset(data_2014c, select = -c(X2015.PRICE.VAR....))
data_2015c <- subset(data_2015c, select = -c(X2016.PRICE.VAR....))
data_2016c <- subset(data_2016c, select = -c(X2017.PRICE.VAR....))
data_2017c <- subset(data_2017c, select = -c(X2018.PRICE.VAR....))
...
set.seed(100)   # use the same seed for every model
ftPLS_C1 <- train(x = data_2014c, y = class2014c, method = "pls",
...
glmnTunedC1 <- train(x = data_2014c, y = class2014c, method = "glmnet",
...
set.seed(100)
nnetModelC1 = train(x = data_2014c, y = class2014c, method = "nnet", 
...
set.seed(100)
avNNetModelC1 = train(x = data_2014c, y = class2014c, method = "avNNet", 
                    preProc = c("center", "scale"), linout = FALSE, trace = FALSE, 
...
svmC1Fit <- train(x = data_2014c, y = class2014c,  method = "svmRadial",
...
# compare the expected classifications in 2015 to the observed classifications in 2015
svmC1_Pred = predict(svmC1Fit, newdata = data_2015c)
